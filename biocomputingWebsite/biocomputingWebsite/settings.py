"""
Django settings for biocomputingWebsite project.
...
INSTALLED_APPS = [
    ...
    'simulationApp.apps.SimulationAppConfig',
...
ROOT_URLCONF = 'biocomputingWebsite.urls'
...
WSGI_APPLICATION = 'biocomputingWebsite.wsgi.application'
